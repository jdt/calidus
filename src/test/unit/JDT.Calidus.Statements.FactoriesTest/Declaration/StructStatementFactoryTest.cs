...
{
    [TestFixture]
    public class StructStatementFactoryTest : CalidusTestBase
    {
        private StructStatementFactory _factory;

        [SetUp]
        public override void SetUp()
        {
            base.SetUp();
            _factory = new StructStatementFactory();
        }

        [Test]
        public void StructIdentifierFollowedByIdentifierShouldBeStructStatement()
        {
