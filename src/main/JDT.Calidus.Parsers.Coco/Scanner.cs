...
public class Scanner
{
    ...
    void CheckLiteral()
    {
        switch (t.val)
        {
            ...
            case "from": t.kind = 121; break;
            case "where": t.kind = 122; break;
            case "join": t.kind = 123; break;
            case "on": t.kind = 124; break;
            case "equals": t.kind = 125; break;
            case "into": t.kind = 126; break;
            case "let": t.kind = 127; break;
            case "orderby": t.kind = 128; break;
            case "ascending": t.kind = 129; break;
            case "descending": t.kind = 130; break;
            case "select": t.kind = 131; break;
            case "group": t.kind = 132; break;
            case "by": t.kind = 133; break;
            case "yield": t.kind = 134; break;
            default: break;
        }
    }
    ...
    Token NextToken()
    {
        ...
        switch (state)
        {
            ...
            case 105:
                if (ch == 'f') { AddCh(); goto case 106; }
                else { t.kind = noSym; break; }
            case 106:
                if (ch == 'i') { AddCh(); goto case 107; }
                else { t.kind = noSym; break; }
            case 107:
            ...
            case 109:
                if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= 65535) { AddCh(); goto case 109; }
            ...
            case 114:
                if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= 65535) { AddCh(); goto case 114; }
            ...
            case 127:
                if (ch == 'r') { AddCh(); goto case 128; }
                else { t.kind = noSym; break; }
            case 128:
                if (ch == 'o') { AddCh(); goto case 129; }
                else { t.kind = noSym; break; }
            case 129:
            ...
            case 133:
                if (ch == 'n') { AddCh(); goto case 134; }
                else { t.kind = noSym; break; }
            case 134:
                if (ch == 'i') { AddCh(); goto case 135; }
                else { t.kind = noSym; break; }
            case 135:
                if (ch == 'n') { AddCh(); goto case 136; }
                else { t.kind = noSym; break; }
            case 136:
                if (ch == 'g') { AddCh(); goto case 137; }
                else { t.kind = noSym; break; }
            case 137:
                if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= 65535) { AddCh(); goto case 137; }
                else { t.kind = 152; break; }
            case 138:
                if (ch == 'e') { AddCh(); goto case 139; }
                else { t.kind = noSym; break; }
            case 139:
                if (ch == 'g') { AddCh(); goto case 140; }
                else { t.kind = noSym; break; }
            case 140:
                if (ch == 'i') { AddCh(); goto case 141; }
                else { t.kind = noSym; break; }
            case 141:
                if (ch == 'o') { AddCh(); goto case 142; }
                else { t.kind = noSym; break; }
            case 142:
                if (ch == 'n') { AddCh(); goto case 143; }
                else { t.kind = noSym; break; }
            case 143:
                if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= 65535) { AddCh(); goto case 143; }
                else { t.kind = 153; break; }
            case 144:
                if (ch == 'e') { AddCh(); goto case 145; }
                else { t.kind = noSym; break; }
            case 145:
                if (ch == 'g') { AddCh(); goto case 146; }
                else { t.kind = noSym; break; }
            case 146:
                if (ch == 'i') { AddCh(); goto case 147; }
                else { t.kind = noSym; break; }
            case 147:
                if (ch == 'o') { AddCh(); goto case 148; }
                else { t.kind = noSym; break; }
            case 148:
                if (ch == 'n') { AddCh(); goto case 149; }
                else { t.kind = noSym; break; }
            case 149:
                if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= 65535) { AddCh(); goto case 149; }
                else { t.kind = 154; break; }
            case 150:
                if (ch == 'r') { AddCh(); goto case 151; }
                else { t.kind = noSym; break; }
            case 151:
                if (ch == 'a') { AddCh(); goto case 152; }
                else { t.kind = noSym; break; }
            case 152:
                if (ch == 'g') { AddCh(); goto case 153; }
                else { t.kind = noSym; break; }
            case 153:
                if (ch == 'm') { AddCh(); goto case 154; }
                else { t.kind = noSym; break; }
            case 154:
