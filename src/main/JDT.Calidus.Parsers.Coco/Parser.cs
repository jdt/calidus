...
public class Parser
{
    ...
    public const int _from = 121;
    public const int _where = 122;
    public const int _join = 123;
    public const int _on = 124;
    public const int _equals = 125;
    public const int _into = 126;
    public const int _let = 127;
    public const int _orderby = 128;
    public const int _ascending = 129;
    public const int _descending = 130;
    public const int _select = 131;
    public const int _group = 132;
    public const int _by = 133;
    public const int maxT = 143;
    public const int _ppDefine = 144;
    public const int _ppUndef = 145;
    public const int _ppIf = 146;
    public const int _ppElif = 147;
    public const int _ppElse = 148;
    public const int _ppEndif = 149;
    public const int _ppLine = 150;
    public const int _ppError = 151;
    public const int _ppWarning = 152;
    public const int _ppRegion = 153;
    public const int _ppEndReg = 154;
    ...
    static BitArray
      ...
      typArgLstFol = NewSet(new int[] {_lpar, _rpar, _rbrack, _colon, _scolon, _comma, _dot,
                 _question, _eq, _neq, _gt, _nullCoal}),
    ...
    // TypeKind
    public enum TypeKind { simple, array, pointer, @void }
    ...
    public virtual void Expect(int n)
    {
        if (la.kind == n) 
            Get(); 
        else 
    ...
    public virtual void ExternAliasDirective()
    {
        Expect(28);
        Expect(1);
    ...
    public virtual void UsingDirective()
    {
        Expect(78);
        if (IsAssignment())
        {
    ...
    public virtual void GlobalAttributes()
    {
        Expect(98);
        Expect(1);
    ...
    public virtual void NamespaceMemberDeclaration()
    {
    ...
    public virtual void ModifierList(Modifiers m)
    {
        while (StartOf(4))
        {
            switch (la.kind)
    ...
    public virtual void TypeDeclaration(Modifiers m)
    {
        TypeKind dummy;
        if (StartOf(5))
        {
    ...
    public virtual void TypeParameterList()
    {
        Expect(101);
        while (la.kind == 98)
        {
    ...
    public virtual void TypeParameterConstraintsClause()
    {
        Expect(1);
    ...
    public virtual void StructBody()
    {
        Expect(97);
        while (StartOf(10))
        {
    ...
    public virtual void InterfaceMemberDeclaration()
    {
        Modifiers m = new Modifiers(this);
    ...
    public virtual void IntegralType()
    {
        switch (la.kind)
        {
            case 59:
    ...
    public virtual void Type(out TypeKind type, bool voidAllowed)
    {
    ...
    public virtual void FormalParameterList()
    {
        TypeKind type;
        while (la.kind == 98)
        {
    ...
    public virtual void ClassMemberDeclaration(Modifiers m)
    {
        if (StartOf(14))
        {
            StructMemberDeclaration(m);
    ...
    public virtual void StructMemberDeclaration(Modifiers m)
    {
    ...
    public virtual void EnumMemberDeclaration()
    {
        while (la.kind == 98)
        {
            Attributes();
    ...
    public virtual void VariableDeclarators(Modifiers m)
    {
        Expect(1);
        if (la.kind == 86)
        {
    ...
    public virtual void EventAccessorDeclarations()
    {
    ...
    public virtual void OverloadableOp(out int op)
    {
        op = plusOp;
        switch (la.kind)
        {
    ...
    public virtual void MemberName()
    {
        Expect(1);
        if (la.kind == 92)
        {
    ...
    public virtual void AccessorDeclarations(Modifiers m)
    {
    ...
    public virtual void InterfaceAccessors(Modifiers m)
    {
        bool getFound = false, setFound = false;
        while (la.kind == 98)
        {
    ...
    public virtual void LocalVariableType()
    {
        TypeKind dummy;
        Type(out dummy, false);
    }

    public virtual void LocalVariableDeclaration()
    {
        LocalVariableType();
    ...
    public virtual void LocalVariableDeclarator()
    {
        TypeKind dummy;
        Expect(1);
    ...
    public virtual void VariableInitializer()
    {
        if (StartOf(19))
        {
            Expression();
    ...
    public virtual void ArrayInitializer()
    {
        Expect(97);
        if (StartOf(23))
        {
    ...
    public virtual void AttributeArguments()
    {
    ...
    public virtual void PrimitiveType()
    {
        if (StartOf(24))
        {
            IntegralType();
    ...
    public virtual void PointerOrArray(out TypeKind type, TypeKind curType)
    {
    ...
    public virtual void ResolvedType()
    {
...
!firstExpr[kindInContext(Peek(1).kind)])
    ...
    public virtual void TypeArgumentList()
    {
        TypeKind dummy;
        Expect(101);
        if (StartOf(16))
    ...
    public virtual void InternalClassType()
    {
        if (la.kind == 48)
        {
            Get();
    ...
    public virtual void EmbeddedStatement()
    {
        TypeKind type;
        if (la.kind == 97)
        {
    ...
    public virtual void StatementExpression()
    {
    ...
    public virtual void SwitchSection()
    {
        SwitchLabel();
    ...
    public virtual void ForInitializer()
    {
        if (IsLocalVarDecl())
        {
            LocalVariableDeclaration();
    ...
    public virtual void ForIterator()
    {
        StatementExpression();
        while (la.kind == 88)
        {
    ...
    public virtual void CatchClauses()
    {
        Expect(13);
        if (la.kind == 97)
        {
    ...
    public virtual void ResourceAcquisition()
    {
        if (IsLocalVarDecl())
        {
            LocalVariableDeclaration();
    ...
    public virtual void AssignmentOperator()
    {
        switch (la.kind)
        {
            case 86:
    ...
    public virtual void SwitchLabel()
    {
        if (la.kind == 12)
        {
            Get();
    ...
    public virtual void QueryExpression()
    {
        enterContext();
        FromClause();
        QueryBody();
    ...
    public virtual void ImplicitLambdaExpression()
    {
        if (la.kind == 1)
        {
    ...
    public virtual void AnonymousMethodParameter()
    {
        TypeKind dummy;
        if (la.kind == 50 || la.kind == 57)
        {
    ...
    public virtual void NullCoalescingExpr()
    {
        OrExpr();
        while (la.kind == 108)
        {
    ...
    public virtual void BitXorExpr()
    {
        BitAndExpr();
        while (la.kind == 138)
        {
    ...
    public virtual void BitAndExpr()
    {
        EqlExpr();
        while (la.kind == 83)
        {
    ...
    public virtual void MulExpr()
    {
        while (la.kind == 118 || la.kind == 140 || la.kind == 141)
        {
            if (la.kind == 118)
            {
                Get();
    ...
    public virtual void ObjectOrCollectionInitializer()
    {
        Expect(97);
        if (StartOf(31))
        {
    ...
    public virtual void AnonymousObjectInitializer()
    {
        Expect(97);
        if (StartOf(19))
        {
    ...
    public virtual void MemberDeclarator()
    {
        if (IsAssignment())
        {
            Expect(1);
    ...
    public virtual void MemberOrElementInitializer()
    {
        if (IsAssignment())
        {
            Expect(1);
    ...
    public virtual void ImplicitAnonymousFunctionParameter()
    {
        Expect(1);
    }

    public virtual void ImplicitTypedLambdaBody()
    {
        if (la.kind == 97)
        {
            Block();
    ...
    public virtual void FromClause()
    {
        TypeKind type;
        Expect(121);
        if (Peek(1).kind != _in)
    ...
    public virtual void QueryBodyClause()
    {
        if (la.kind == 121)
        {
            FromClause();
    ...
    public virtual void SelectClause()
    {
        Expect(131);
        Expression();
    }

    public virtual void GroupClause()
    {
        Expect(132);
        Expression();
        Expect(133);
    ...
    public virtual void WhereClause()
    {
        Expect(122);
        Expression();
    }

    public virtual void JoinClause()
    {
        TypeKind type;
        Expect(123);
        if (Peek(1).kind != _in)
    ...
    public virtual void OrderByClause()
    {
        Expect(128);
        Ordering();
        while (la.kind == 88)
    ...
    static readonly bool[,] set = {
		{T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,T,x, x,x,x,x, x,x,x,x, T,x,x,x, x,T,x,x, x,T,x,x, T,x,x,x, x,x,x,x, x,x,x,x, T,T,x,x, x,T,T,x, x,x,x,T, x,T,T,T, T,x,x,x, T,x,x,x, T,x,T,x, x,x,x,x, x,x,x,x, T,x,x,T, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,T,x, x,x,x,x, x,x,x,x, T,x,x,x, x,T,x,x, x,T,x,x, T,x,x,x, x,x,x,x, x,x,x,x, T,T,x,x, x,x,T,x, x,x,x,T, x,T,T,T, T,x,x,x, T,x,x,x, T,x,T,x, x,x,x,x, x,x,x,x, T,x,x,T, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,T,x,x, x,x,T,x, x,x,x,T, x,T,T,T, T,x,x,x, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, T,x,x,T, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,T,x,T, x,x,T,x, x,x,x,T, x,x,x,T, x,x,T,x, x,x,x,x, T,x,x,x, x,x,x,T, x,x,x,x, T,x,T,x, T,x,x,x, x,x,x,x, x,x,x,T, x,T,x,x, x,T,x,x, x,x,x,x, x,T,T,x, T,T,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,T,x,T, x,x,T,x, x,x,x,T, x,x,x,T, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,T, x,x,x,x, T,x,x,x, T,x,T,x, T,x,x,x, x,T,x,T, x,T,x,x, x,T,x,x, T,x,x,x, x,T,T,x, x,T,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,T,x, x,T,x,T, x,x,T,x, T,T,x,T, x,T,x,T, x,T,T,T, T,x,x,T, T,x,x,x, x,T,x,T, T,T,x,x, T,x,T,x, T,x,x,T, x,T,T,T, T,x,x,T, T,T,x,x, T,T,T,x, x,x,x,x, x,T,T,x, T,T,x,T, T,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,T,x, x,T,x,T, x,x,T,x, T,T,x,T, x,T,x,T, x,T,T,T, T,x,x,T, T,x,x,x, x,T,x,T, T,T,x,x, T,x,T,x, T,x,x,T, x,T,T,T, T,x,x,T, T,T,x,x, T,T,T,x, x,x,x,x, x,T,T,x, T,T,x,T, T,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,T,x,T, x,x,T,x, x,x,x,T, x,x,x,T, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,T, x,x,x,x, T,x,T,x, T,x,x,x, x,x,x,x, x,x,x,T, x,T,x,x, x,T,x,x, x,x,x,x, x,T,T,x, T,T,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,T,x,T, x,x,T,x, x,x,x,T, x,x,x,T, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,T, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,T,x,x, x,x,x,x, x,x,x,x, x,T,T,x, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,T,x,T, x,x,T,x, x,x,x,T, x,x,x,T, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,T, x,x,x,x, T,x,x,x, T,x,T,x, x,x,x,x, x,T,x,T, x,T,x,x, x,T,x,x, T,x,x,x, x,T,T,x, x,T,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,T,x,T, x,x,T,x, T,T,x,T, x,T,x,T, x,T,T,T, x,x,x,T, T,x,x,x, x,T,x,T, T,x,x,x, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,T, x,T,x,x, x,T,T,x, x,x,x,x, x,T,T,x, x,T,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,T, T,T,x,x, T,T,x,T, x,x,T,T, x,x,x,T, T,T,x,T, x,x,x,x, x,T,x,x, T,x,x,x, x,x,x,T, x,x,x,x, T,x,T,T, T,x,T,x, x,x,x,x, x,T,x,T, x,T,T,x, x,T,x,x, T,x,T,x, T,T,T,T, x,T,x,x, x,x,x,T, x,x,x,x, x,T,x,x, x,x,x,x, T,x,x,T, x,x,x,T, x,x,x,T, x,x,T,x, x,x,x,x, x,T,T,x, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,T,x,T, x,x,T,x, x,x,x,T, x,x,x,T, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,T, x,x,x,x, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,T, x,T,x,x, x,T,x,x, x,x,x,x, x,T,T,x, x,T,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,T, T,T,x,x, T,T,T,T, x,x,T,T, x,T,T,T, T,T,T,T, x,x,x,x, x,T,x,T, T,T,T,T, T,x,x,T, x,x,x,T, T,x,T,T, T,x,x,x, x,x,x,x, x,x,T,T, x,T,T,x, x,T,x,T, T,T,T,T, T,T,T,T, T,T,T,x, T,x,T,T, x,x,x,x, x,T,x,x, x,x,x,x, T,T,x,T, x,x,x,T, x,x,x,T, x,x,T,x, x,x,x,x, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,T,x,T, x,x,T,x, x,x,x,T, x,x,x,T, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,T, x,x,x,x, T,x,x,x, T,x,T,x, x,x,x,x, x,T,x,T, x,T,x,x, x,T,x,x, x,x,x,x, x,T,T,x, x,T,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,T, T,T,x,x, T,T,x,T, x,x,T,T, x,x,x,T, T,T,x,T, x,x,x,x, x,T,x,x, T,x,x,x, x,x,x,T, x,x,x,x, T,x,T,T, T,x,x,x, x,x,x,x, x,x,x,T, x,T,T,x, x,T,x,x, T,x,T,x, T,T,T,T, x,T,x,x, x,x,x,T, x,x,x,x, x,T,x,x, x,x,x,x, T,x,x,T, x,x,x,T, x,x,x,T, x,x,T,x, x,x,x,x, x,T,T,x, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,T, T,T,x,x, T,T,x,T, x,x,T,T, x,x,x,T, T,T,x,T, x,x,x,x, x,T,x,x, T,x,x,x, x,x,x,T, x,x,x,x, T,x,T,T, T,x,x,x, x,x,x,x, x,x,x,T, x,T,T,x, x,T,x,x, T,x,T,x, T,T,T,T, x,T,x,x, x,x,x,T, x,x,x,x, x,T,x,x, x,x,x,x, T,x,x,T, x,x,x,T, x,x,x,T, x,x,T,x, x,x,x,x, x,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,T, T,x,x,x, x,T,T,T, x,x,x,x, x,T,T,T, x,x,T,x, T,x,T,x, T,T,T,T, T,x,T,x, x,T,T,T, T,T,T,T, T,T,T,T, T,T,x,T, T,T,T,T, T,T,x,x, x},
		{x,T,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,T,x,x, x,x,T,x, x,x,x,T, x,T,T,T, T,x,x,x, T,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, T,x,x,T, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,T, T,T,x,x, T,T,x,T, x,x,T,T, x,x,x,T, T,T,x,T, x,x,x,x, x,T,x,x, T,x,x,x, x,x,x,T, x,x,x,x, T,x,T,T, T,x,x,x, x,x,x,x, x,x,x,T, x,T,T,x, x,T,x,x, T,x,T,x, T,T,T,T, x,T,x,x, x,x,x,T, x,x,x,x, x,T,x,x, x,x,x,x, T,T,x,T, x,x,x,T, x,x,x,T, x,x,T,x, x,x,x,x, x,T,T,x, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,x,T, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,T,x,x, x,x,x,x, x,x,x,x, x,T,T,x, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,T, T,T,x,x, T,T,T,T, x,x,T,T, x,x,T,T, T,T,T,T, x,x,x,x, x,T,x,T, T,T,T,T, T,x,x,T, x,x,x,T, T,x,T,T, T,x,x,x, x,x,x,x, x,x,T,T, x,T,T,x, x,T,x,T, T,T,T,T, T,T,T,T, T,T,T,x, x,x,T,T, x,x,x,x, x,T,x,x, x,x,x,x, T,T,x,T, x,x,x,T, x,x,x,T, x,x,T,x, x,x,x,x, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,T, T,T,x,x, T,T,x,T, x,x,T,T, x,x,x,T, T,T,x,T, x,x,x,x, x,T,x,x, T,x,x,x, x,x,x,T, x,x,x,x, T,x,T,T, T,x,x,x, x,x,x,x, x,x,x,T, x,T,T,x, x,T,x,x, T,x,T,x, T,T,T,T, x,T,x,x, T,x,x,T, x,x,x,x, x,T,x,x, x,x,x,x, T,x,x,T, x,x,x,T, x,x,x,T, x,x,T,x, x,x,x,x, x,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,T,x, x,x,T,x, x,x,T,x, x,x,x,x, T,x,x,x, T,T,x,x, x,T,x,T, x,x,x,x, x,x,x,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,T, x,x,x,x, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,T, x,x,x,x, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,x,T, x,x,x,x, T,x,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x},
		{x,T,T,T, T,T,x,x, T,T,x,T, x,x,T,T, x,x,x,T, T,T,x,T, x,x,x,x, x,T,x,x, T,x,x,x, x,x,x,T, x,x,x,x, T,x,T,T, T,x,T,x, x,x,x,x, x,T,x,T, x,T,T,x, x,T,x,x, T,x,T,x, T,T,T,T, x,T,x,x, x,x,x,T, x,x,x,x, x,T,x,x, x,x,x,x, T,T,x,T, x,x,x,T, x,x,x,T, x,x,T,x, x,x,x,x, x,T,T,x, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,T, x,x,x,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x}
...
public class Errors
{
    ...
    public void SynErr(int line, int col, int n)
    {
        ...
        switch (n)
        {
            ...
            case 121: s = "from expected"; break;
            case 122: s = "where expected"; break;
            case 123: s = "join expected"; break;
            case 124: s = "on expected"; break;
            case 125: s = "equals expected"; break;
            case 126: s = "into expected"; break;
            case 127: s = "let expected"; break;
            case 128: s = "orderby expected"; break;
            case 129: s = "ascending expected"; break;
            case 130: s = "descending expected"; break;
            case 131: s = "select expected"; break;
            case 132: s = "group expected"; break;
            case 133: s = "by expected"; break;
            case 134: s = "\"yield\" expected"; break;
            ...
            case 144: s = "invalid NamespaceMemberDeclaration"; break;
            case 145: s = "invalid Attributes"; break;
            case 146: s = "invalid TypeDeclaration"; break;
            case 147: s = "invalid TypeDeclaration"; break;
            case 148: s = "invalid TypeParameterConstraintsClause"; break;
            case 149: s = "invalid InterfaceMemberDeclaration"; break;
            case 150: s = "invalid InterfaceMemberDeclaration"; break;
            case 151: s = "invalid InterfaceMemberDeclaration"; break;
            case 152: s = "invalid IntegralType"; break;
            case 153: s = "invalid Type"; break;
            case 154: s = "invalid FormalParameterList"; break;
            case 155: s = "invalid ClassType"; break;
            case 156: s = "invalid ClassMemberDeclaration"; break;
            case 157: s = "invalid ClassMemberDeclaration"; break;
            ...
            case 171: s = "invalid Expression"; break;
            ...
            case 188: s = "invalid ResolvedType"; break;
            case 189: s = "invalid TypeArgumentList"; break;
            case 190: s = "invalid TypeArgumentList"; break;
            case 191: s = "invalid InternalClassType"; break;
            ...
            case 197: s = "invalid StatementExpression"; break;
            case 198: s = "invalid ForInitializer"; break;
            case 199: s = "invalid CatchClauses"; break;
            case 200: s = "invalid ResourceAcquisition"; break;
            case 201: s = "invalid Unary"; break;
            case 202: s = "invalid AssignmentOperator"; break;
            case 203: s = "invalid SwitchLabel"; break;
            case 204: s = "invalid ImplicitLambdaExpression"; break;
            case 205: s = "invalid RelExpr"; break;
            case 206: s = "invalid RelExpr"; break;
            case 207: s = "invalid ShiftExpr"; break;
            case 208: s = "invalid Primary"; break;
            case 209: s = "invalid Primary"; break;
            case 210: s = "invalid Primary"; break;
            case 211: s = "invalid Literal"; break;
            case 212: s = "invalid MemberOrElementInitializer"; break;
            case 213: s = "invalid MemberOrElementInitializer"; break;
            case 214: s = "invalid ImplicitTypedLambdaBody"; break;
            case 215: s = "invalid QueryBody"; break;
            case 216: s = "invalid QueryBodyClause"; break;
